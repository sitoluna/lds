...
<head>
	...
	<title>LunaDeSevilla - Calendar Availability</title>
</head>
<body>
				...
				<table width="100%" summary="menu de apartamentos">
					<tr align="center" style="background: url(backoffice/images/bgul.gif) repeat-x;border: 1px solid #FAFAFA;">
						<td width="33%" <?php if($appartment == "bajo") echo "id='optSelected'"?>>
							<a href="rentalCalendar.php?appartment=bajo&month=<?php echo $month;?>&year=<?php echo $year;?>">Ground floor</a>
						</td>
						<td width="33%" <?php if($appartment == "primero") echo "id='optSelected'"?>>
							<a href="rentalCalendar.php?appartment=primero&month=<?php echo $month;?>&year=<?php echo $year;?>">First floor</a>
						</td>
						<td <?php if($appartment == "segundo") echo "id='optSelected'"?>>
							<a href="rentalCalendar.php?appartment=segundo&month=<?php echo $month;?>&year=<?php echo $year;?>">Second floor</a>
						</td>
					</tr>
				</table>
				<br/>
				<div class="calendar">
					<?php printCalendar($appartment, $year, $month, "../backoffice/rentalCalendar/", "en");?>
						<br/>
						<br/>
						<table summary="leyenda">
							<tr>
								<td id="libre">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>Available</td>
								<td id="ocupado">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>Occupied</td>
								<td id="reservado">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>Reserved</td>
							</tr>
						</table>
					</div>
			</div>
